...
layout: default
eyebrow: Skills
subtitle: "21 skills, one panel per hat. Pick a hat, scan, open any row for the deep dive. Lost in the pipeline? Run `wb.wtd` ([ref](skills/wtd.html)) or read [Workflows](workflows.html)."
---
...
<details markdown="1">
<summary><strong>Cross-Cutting</strong> · 5 skills · grill-me + grill-me-auto + PMO status + WTD + precise-readme</summary>

| Skill | Purpose | Input gate |
|---|---|---|
| [`/grill-me`](skills/grill-me.html) | Relentless decision-tree interview on any draft before publish | any draft artifact |
| [`/grill-me-auto`](skills/grill-me-auto.html) | Batch-mode `/grill-me`: all questions written into one collapsible markdown doc, answered in one reply | any draft artifact |
...
| [`/precise-readme`](skills/precise-readme.html) | Precision-mode pass on README + `docs/`; archives originals under `docs/v1/` with cross-banners. | README + `docs/` exist |
...
| Cross-cutting | `/grill-me`, `/grill-me-auto`, `/pmo-status`, `/wtd`, `/precise-readme` |
